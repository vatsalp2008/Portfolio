...
export default function Portfolio() {
  ...
  return (
    <div className="bg-[#0a0a0a] text-[#e5e5e5] min-h-screen">
      {/* Navigation */}
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-[#0a0a0a]/95 backdrop-blur-md border-b border-[#DC0000]/20" : "bg-transparent"
        }`}>
